...
export const collections = sqliteTable(
  ...
  (table) => [uniqueIndex('collection_name_idx').on(table.name)]
);
...
export const feeds = sqliteTable(
  ...
  (table) => [uniqueIndex('feed_url_idx').on(table.url)]
);
...
export const feedItems = sqliteTable(
  ...
  (table) => [uniqueIndex('feed_item_link_idx').on(table.link)]
);

// Add a new table for AI Analysis Logs
export const aiAnalysisLogs = sqliteTable(
  'ai_analysis_logs',
  {
    id: text('id').primaryKey(),
