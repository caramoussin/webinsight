...
const mockExtractContentResponse = {
	content: {
		markdown: 'it markdown content',
		raw_markdown: 'it raw content',
		html: '<p>it HTML content</p>'
	},
	extracted_data: {
		title: 'it Title'
	},
...
describe('Crawl4AI MCP Provider', () => {
	...
	describe('extractContent', () => {
		it('should extract content from a URL', () =>
			pipe(
				E.gen(function* (_) {
					const params = {
						url: 'https://example.com',
	...
	describe('checkRobotsTxt', () => {
		it('should check robots.txt rules', () =>
			pipe(
				E.gen(function* (_) {
					const params = {
						url: 'https://example.com'
	...
	describe('callTool', () => {
		...
		it('should call checkRobotsTxt tool successfully', () =>
			pipe(
				E.gen(function* (_) {
